...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let c = {id = new_id (); action = listener} in
    evt := c :: !evt;
    c.id 
...
let receive_report (s : string) : unit = 
  let _ = WEvent.add_listener publish (fun () -> ignore (fakeNewsNetwork s)) in
  let _ = WEvent.add_listener publish (fun () -> ignore (buzzFake s)) in
  () ;;
